...
const GraphsEnf: React.FC<IProps> = ({ value, citiesLeito }) => {
  console.log("grafico");
      ...
      <Line>
        ...
        <Bar>
          ...
          <Chart
            ...
            series={ [{name:'Ocupado', data:[citiesLeito.totAdmittedSUS_infirmary]}] }
            type="area"
            width="700"
            />
        </Bar>
        ...
        <Bar>
          ...
          <Chart
            ...
            series={ [{name:'Ocupado', data:[citiesLeito.totAdmittedPrivate_infirmary]}] }
            type="area"
            width="700"
            />
        </Bar>
